...
if (window.getComputedStyle(all).display === "none")
{
    ...
    all.innerHTML="<h1 style='text-align:center;display:flex;align-items:center;justify-content: center;height: calc(100vh - 20px);color: #017296;margin: 0;padding: 0;' >Please Visit From Desktop</h1>";
}
